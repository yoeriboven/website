...
I spent way too much time figuring out how to increase the limit so if you're using Laravel Valet, here's how to increase the maximum time of a request.
...
```bash
nano /opt/homebrew/etc/nginx/valet/valet.conf
```

                    ...
                    <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" enter-to="opacity-100 translate-y-0 sm:scale-100" leave="ease-in duration-200" leave-from="opacity-100 translate-y-0 sm:scale-100" leave-to="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
                        <DialogPanel class="relative max-h-[35rem] overflow-y-scroll inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                            <div>
                                <div class="">
                                    <div>
                                        <DialogTitle as="h3" class="text-lg leading-6 font-medium text-gray-700">
                            ...
                            <div class="mt-5 sm:mt-6 space-y-2">
                                <a :href="featuredProject.link"
                                   target="_blank"
                                   class="inline-flex justify-center w-full rounded-md shadow-sm px-4 py-2 border border-gray-300 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 sm:text-sm">
                                    View code
                                </a>
                                <button
                                      @click="$emit('close')"
